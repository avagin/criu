...
static int populate_newlink_req(struct ns_id *ns, struct newlink_req *req, int msg_type, struct net_link * link,
		int (*link_info)(struct ns_id *ns, struct net_link *, struct newlink_req *), struct newlink_extras *extras)
{
...
static int do_rtm_link_req(int msg_type, struct net_link *link,
		int nlsk, struct ns_id *ns,
		int (*link_info)(struct ns_id *ns, struct net_link *, struct newlink_req *),
